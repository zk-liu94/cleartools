...
document.addEventListener("DOMContentLoaded", function() {
  ...
  if (footer && !document.getElementById("subscribe-section-injected")) {
    ...
    sub.innerHTML = '<h2>Get Weekly English Writing Tips</h2><p>Join English learners who improve their writing with free tips, tools, and resources delivered to your inbox every week.</p><button class="btn btn-primary btn-lg" onclick="ml(\'show\', \'yqoy61\', true)" style="font-size:1.05rem;padding:.8rem 2rem;border:none;cursor:pointer">Subscribe Free</button><p class="subscribe-small">No spam. Unsubscribe anytime.</p>';
